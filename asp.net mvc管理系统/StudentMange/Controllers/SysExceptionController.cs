...
namespace StudentMange.Controllers
{
    ...
    {
        public SysExceptionIBLL.SysExceptionIBLL Rep = new SysExceptionBLL.SysExceptionBLL();
        // GET: SysException
        ...
        {
            List<SysExceptionModel> list = Rep.GetList(ref pager, queryStr);
            var json = new
            {
        ...
        public ActionResult Details(string id)
        {
            ...
            SysExceptionModel entity = Rep.GetById(id);
